...
/*Variables to change */
int rows = 48; /* NUMBER OF ESSAYS */
int cols = 53; /* NUMBER OF STUDENTS  */
#define cols 53
int numLec = 48; /* NUMBER OF LECTURERS */
char fileName1[] = "StudentEssayExample.csv"; /* This file has the data to fill choices - is passed into readChoices */
char fileName2[] = "SupervisorEssayExample.csv"; /* This file has the data to fill in supConstraint - is passed into readLecturers */
...
float weight5 = ((float)100/(float)cols) * ((float)1.5/(float)4.7); /* Initial test of a reasonable fifth weight - can be changed if needed */
